    ...
    <>
      <motion.header
        ...
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
          scrolled ? 'py-3 backdrop-blur-2xl shadow-sm' : 'py-5 bg-transparent'
        }`}
        style={
          scrolled
        ...
        <div className="max-w-7xl mx-auto px-6 relative flex items-center justify-end md:justify-between">
          ...
          >
            <span className="flex items-center gap-2 text-[1.85rem] sm:text-[1.95rem]">
              <span>G</span>
              <Heart size={15} strokeWidth={1.9} className="translate-y-[1px]" style={{ color: 'var(--accent-gold)' }} fill="none" aria-hidden="true" />
              <span>W</span>
            </span>
          </motion.a>
